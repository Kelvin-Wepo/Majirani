...
from .forms import RegisterForm, ProfileEdit, BusinessForm, SearchForm, PostForm
...
def home(request):
    ...
    return render(request, 'all neighbours/index.html',{"title":'Home','form':form,'searchform':searchform})
...
def profile(request):
    ...
    return render(request, 'all neighbours/profile.html',{"title":'Profile',"profile":profile,"form":form})
...
def business(request):
    ...
    return render(request, 'all neighbours/business.html',{"title":'Business/Events','form':form,"business":business,'user':user})

@login_required(login_url='login')
def contact(request):
    user = request.user
    if not user.profile:
        return render(request, 'all neighbours/nineOneone.html',{"title":'Emergency Contact','user':user})
    ...
    return render(request, 'all neighbours/nineOneone.html',{"title":'Emergency Contact','user':user,"police":police,"medics":medics})
...
def post(request):
    ...
    return render(request,'all neighbours/post.html',{'form':form})
# Create your views here.
